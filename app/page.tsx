    ...
    <div className="site-shell">
      ...
      <main id="main-content">
        ...
        <section className="section method-section" id="sources" aria-labelledby="method-title">
          ...
          <div className="source-note"><span>LAST UPDATED</span><strong>2026.07.24</strong><p>공개 원문 39건을 큐레이션했습니다. 이번 업데이트에는 일본 디지털청의 2026년 7월 21일 중점계획에서 AI 활용 가이드라인, 이용자 중심 설계, DMP, 아날로그 규제, 베이스 레지스트리, 법령 데이터, DevStack, 공공서비스 메쉬, 지자체 AX/DX 항목을 추가로 뽑았습니다. 수치는 원문 발표 기준이며, 정부 발표와 민간 리서치의 성격이 다르므로 직접 비교하기보다 설계 질문을 찾는 용도로 읽어주세요.</p></div>
        </section>
      </main>
